// app/admin/crypto-receipts/components/receipt-generator/index.ts
export { default as BinanceReceipt } from './BinanceReceipt';
...
// export { default as VenmoReceipt } from './VenmoReceipt';
// export { default as RoquqReceipt } from './RoquqReceipt';