...
import { Search, Filter, ArrowDown, ArrowUp, Clock, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="p-6 bg-[#0b0e14] text-white space-y-6 max-w-6xl mx-auto">
      <div className="flex justify-between items-center border-b border-white/5 pb-4">
        <div>
          ...
          <p className="text-[#8e96a3] text-sm">Complete record of your trades and deposits.</p>
        </div>
      </div>
      ...
      <div className="bg-[#141a24] border border-white/5 rounded-2xl p-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
          ...
          <div className="relative w-full md:w-64">
            ...
            <input 
              type="text" 
              placeholder="Search by TXID or Pair..." 
              value={searchTerm}
